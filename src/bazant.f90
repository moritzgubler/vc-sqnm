subroutine forces_bazant(nat0, alat0, rxyz0, etot0, fxyz0, stress0) bind(C,name='forces_bazant')
  use, intrinsic :: iso_c_binding
  implicit none
  integer(c_int), intent(in) :: nat0
  real(c_double), intent(in) :: alat0(3,3), rxyz0(3, nat0)
  real(c_double), intent(out) :: fxyz0(3, nat0), stress0(3,3), etot0

  integer :: nat
  real(8) :: alat(3,3), rxyz(3,nat0), etot, fxyz(3,nat0), deralat(3,3), stress(3,3)
  integer :: i
  ...
  call energyandforces_bazant(nat, alat, rxyz, etot, fxyz, deralat, stress)
  etot0 = etot
  fxyz0 = fxyz
  stress0 = - stress
  do i = 1, 3
...
subroutine energyandforces_bazant(nat, alat0, rxyz0, etot, fxyz, deralat, stress) !bind ( C, name="energyandforces_bazant" )
!use iso_c_binding
  !   forces-edip.f
  !   -------------
